...
import { serviceSeven } from './ServiceSevenData';
import { ArrowRight, FlameKindling } from 'lucide-react';

const ServiceSevenDesign = () => {
    ...
    <div className="min-h-screen bg-[#f4f3ee] relative overflow-hidden">
      ...
      <div className="relative z-10 py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4 relative pt-16">
          ...
          >
            <FlameKindling className="w-16 h-16 text-[#dda15e]" />
          </motion.div>
          ...
          >
           Perfect coordination of all traditional ceremonies
          </motion.p>
        ...
        >
          {serviceSeven.map((service, index) => (
            <motion.div
...
export default ServiceSevenDesign;