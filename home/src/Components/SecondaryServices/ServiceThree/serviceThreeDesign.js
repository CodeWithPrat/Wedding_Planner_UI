...
import { serviceThree } from './serviceThreeData';
import { ArrowRight, Sparkles } from 'lucide-react';

const ServiceThreeDesign = () => {
    ...
    <div className="min-h-screen bg-[#f4f3ee] relative overflow-hidden">
      ...
      <div className="relative z-10 py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4 relative pt-16">
          ...
          >
            <Sparkles className="w-16 h-16 text-[#dda15e]" />
          </motion.div>
          ...
          >
            Transform your venue into a magical setting
          </motion.p>
        ...
        >
          {serviceThree.map((service, index) => (
            <motion.div
...
export default ServiceThreeDesign;