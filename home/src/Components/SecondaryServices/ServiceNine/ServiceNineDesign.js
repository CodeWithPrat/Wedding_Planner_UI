...
import { ServiceNine } from './ServiceNineData';
import { ArrowRight, Wand } from 'lucide-react';

const ServiceNineDesign = () => {
    ...
    <div className="min-h-screen bg-[#f4f3ee] relative overflow-hidden">
      ...
      <div className="relative z-10 py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4 relative pt-16">
          ...
          >
            <Wand className="w-16 h-16 text-[#dda15e]" />
          </motion.div>
          ...
          >
           Complete beauty and styling solutions
          </motion.p>
...
export default ServiceNineDesign;