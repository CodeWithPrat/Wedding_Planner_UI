...
import { serviceEight } from './serviceEightData';
import { ArrowRight, Briefcase } from 'lucide-react';

const ServiceEightDesign = () => {
    ...
    <div className="min-h-screen bg-[#f4f3ee] relative overflow-hidden">
      ...
      <div className="relative z-10 py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4 relative pt-16">
          ...
          >
            <Briefcase className="w-16 h-16 text-[#dda15e]" />
          </motion.div>
          ...
          >
           Comprehensive guest experience coordination
          </motion.p>
        ...
        >
          {serviceEight.map((service, index) => (
            <motion.div
...
export default ServiceEightDesign;