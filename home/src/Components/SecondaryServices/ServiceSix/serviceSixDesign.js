...
import { serviceSix } from './serviceSixData';
import { ArrowRight, Camera } from 'lucide-react';

const ServiceSixDesign = () => {
    ...
    <div className="min-h-screen bg-[#f4f3ee] relative overflow-hidden">
      ...
      <div className="relative z-10 py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4 relative pt-16">
          ...
          >
            <Camera className="w-16 h-16 text-[#dda15e]" />
          </motion.div>
          ...
          >
            Capture every precious moment of your celebration
          </motion.p>
...
export default ServiceSixDesign;