...
import { serviceTwo } from './ServiceTwoData';
import { ArrowRight, Plane } from 'lucide-react';

const ServiceTwoDesign = () => {
    ...
    <div className="min-h-screen bg-[#f4f3ee] relative overflow-hidden">
      ...
      <div className="relative z-10 py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4 relative pt-16">
          ...
          >
            <Plane className="w-16 h-16 text-[#dda15e]" />
          </motion.div>
          ...
          >
            Where Every Journey Feels Like a Celebration!
          </motion.p>
...
export default ServiceTwoDesign;