...
import { serviceFive } from './serviceFiveData';
import { ArrowRight, UtensilsCrossed } from 'lucide-react';

const ServiceFiveDesign = () => {
    ...
    <div className="min-h-screen bg-[#f4f3ee] relative overflow-hidden">
      ...
      <div className="relative z-10 py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4 relative pt-16">
          ...
          >
            <UtensilsCrossed className="w-16 h-16 text-[#dda15e]" />
          </motion.div>
          ...
          >
            Exquisite culinary experiences for your celebration
          </motion.p>
...
export default ServiceFiveDesign;